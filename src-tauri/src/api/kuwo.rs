...
const C0: [i64; 64] = [
    0x1f, 0x0, 0x1, 0x2, 0x3, 0x4, -0x1, -0x1, 0x3, 0x4, 0x5, 0x6, 0x7, 0x8, -0x1, -0x1,
    0x7, 0x8, 0x9, 0xa, 0xb, 0xc, -0x1, -0x1, 0xb, 0xc, 0xd, 0xe, 0xf, 0x10, -0x1, -0x1,
    0xf, 0x10, 0x11, 0x12, 0x13, 0x14, -0x1, -0x1, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, -0x1, -0x1,
    0x17, 0x18, 0x19, 0x1a, 0x1b, 0x1c, -0x1, -0x1, 0x1b, 0x1c, 0x1d, 0x1e, 0x1f, 0x1e, -0x1, -0x1
];
...
const P: [i64; 32] = [
    0xf, 0x6, 0x13, 0x14, 0x1c, 0xb, 0x1b, 0x10, 0x0, 0xe, 0x16, 0x19, 0x4, 0x11, 0x1e, 0x9,
    0x1, 0x7, 0x17, 0xd, 0x1f, 0x1a, 0x2, 0x8, 0x12, 0xc, 0x1d, 0x5, 0x15, 0xa, 0x3, 0x18
];
...
const S: [i64; 64] = [
    0xd, 0x10, 0xa, 0x17, 0x0, 0x4, -0x1, -0x1, 0x2, 0x1b, 0xe, 0x5, 0x14, 0x9, -0x1, -0x1,
    0x16, 0x12, 0xb, 0x3, 0x19, 0x7, -0x1, -0x1, 0xf, 0x6, 0x1a, 0x13, 0xc, 0x1, -0x1, -0x1,
    0x28, 0x33, 0x1e, 0x24, 0x2e, 0x36, -0x1, -0x1, 0x1d, 0x27, 0x32, 0x2c, 0x20, 0x2f, -0x1, -0x1,
    0x2b, 0x30, 0x26, 0x37, 0x21, 0x34, -0x1, -0x1, 0x2d, 0x29, 0x31, 0x23, 0x1c, 0x1f, -0x1, -0x1
];

const SBOX: [[u8; 64]; 8] = [
    [
        14, 4, 3, 15, 2, 13, 5, 3, 13, 14, 6, 9, 11, 2, 0, 5, 4, 1, 10, 12, 15, 6, 9, 10,
        1, 8, 12, 7, 8, 11, 7, 0, 0, 15, 10, 5, 14, 4, 9, 10, 7, 8, 12, 3, 13, 1, 3, 6,
        15, 12, 6, 11, 2, 9, 5, 0, 4, 2, 11, 14, 1, 7, 8, 13
    ],
    [
        15, 0, 9, 5, 6, 10, 12, 9, 8, 7, 2, 12, 3, 13, 5, 2, 1, 14, 7, 8, 11, 4, 0, 3,
        14, 11, 13, 6, 4, 1, 10, 15, 3, 13, 12, 11, 15, 3, 6, 0, 4, 10, 1, 7, 8, 4, 11, 14,
        13, 8, 0, 6, 2, 15, 9, 5, 7, 1, 10, 12, 14, 2, 5, 9
    ],
    [
        10, 13, 1, 11, 6, 8, 11, 5, 9, 4, 12, 2, 15, 3, 2, 14, 0, 6, 13, 1, 3, 15, 4, 10,
        14, 9, 7, 12, 5, 0, 8, 7, 13, 1, 2, 4, 3, 6, 12, 11, 0, 13, 5, 14, 6, 8, 15, 2,
        7, 10, 8, 15, 4, 9, 11, 5, 9, 0, 14, 3, 10, 7, 1, 12
    ],
    [
        7, 10, 1, 15, 0, 12, 11, 5, 14, 9, 8, 3, 9, 7, 4, 8, 13, 6, 2, 1, 6, 11, 12, 2,
        3, 0, 5, 14, 10, 13, 15, 4, 13, 3, 4, 9, 6, 10, 1, 12, 11, 0, 2, 5, 0, 13, 14, 2,
        8, 15, 7, 4, 15, 1, 10, 7, 5, 6, 12, 11, 3, 8, 9, 14
    ],
    [
        2, 4, 8, 15, 7, 10, 13, 6, 4, 1, 3, 12, 11, 7, 14, 0, 12, 2, 5, 9, 10, 13, 0, 3,
        1, 11, 15, 5, 6, 8, 9, 14, 14, 11, 5, 6, 4, 1, 3, 10, 2, 12, 15, 0, 13, 2, 8, 5,
        11, 8, 0, 15, 7, 14, 9, 4, 12, 7, 10, 9, 1, 13, 6, 3
    ],
    [
        12, 9, 0, 7, 9, 2, 14, 1, 10, 15, 3, 4, 6, 12, 5, 11, 1, 14, 13, 0, 2, 8, 7, 13,
        15, 5, 4, 10, 8, 3, 11, 6, 10, 4, 6, 11, 7, 9, 0, 6, 4, 2, 13, 1, 9, 15, 3, 8,
        15, 3, 1, 14, 12, 5, 11, 0, 2, 12, 14, 7, 5, 10, 8, 13
    ],
    [
        4, 1, 3, 10, 15, 12, 5, 0, 2, 11, 9, 6, 8, 7, 6, 9, 11, 4, 12, 15, 0, 3, 10, 5,
        14, 13, 7, 8, 13, 14, 1, 2, 13, 6, 14, 9, 4, 1, 2, 14, 11, 13, 5, 0, 1, 10, 8, 3,
        0, 11, 3, 5, 9, 4, 15, 2, 7, 8, 12, 15, 10, 7, 6, 12
    ],
    [
        13, 7, 10, 0, 6, 9, 5, 15, 8, 4, 3, 10, 11, 14, 12, 5, 2, 11, 9, 6, 15, 12, 0, 3,
        4, 1, 14, 13, 1, 2, 7, 8, 1, 2, 12, 15, 10, 4, 0, 3, 13, 14, 6, 9, 7, 8, 9, 6,
...
pub async fn get_kuwo_url(client: &Client, songmid: &str, quality: &str) -> Result<String, Box<dyn Error + Send + Sync>> {
    ...
    if body_str.contains("bitrate=1\r\n") {
        return Err("Kuwo returned empty bitrate (VIP / copyright)".into());
    }

    if let Some(start_idx) = body_str.find("url=") {
        let url_part = &body_str[start_idx + 4..];
        let end_idx = url_part.find("\r\n").or_else(|| url_part.find('\n')).unwrap_or(url_part.len());
        let full_url = &url_part[..end_idx];
        let url_without_query = full_url.split('?').next().unwrap_or(full_url);
        return Ok(url_without_query.to_string());
    }

    Err(format!("Kuwo parsing failed: {}", body_str).into())
}
...
mod tests {
    ...
    fn test_kuwo_crypto() {
        ...
        use base64::{Engine as _, engine::general_purpose::STANDARD as BASE64_STANDARD};
        let q_params = BASE64_STANDARD.encode(&enc_bytes);
        assert_eq!(q_params, "18NsawlyRyRtNBB3YsCCYL6ViZJYU1V9YBbTxJJUSf9p8lacnpS0hlBvB+O3STOLkOQ9yIuZWZQZe7UvfQE6Zwn6AeQojd5MyPZr2iJoyOzi94OXIkC0yc+NwbIR+ERWTYsVc58LtjS25laWOGjchw==");
    }
}
