...
/**
 * 只由「行 + 文本」决定的静态方案。
 * 构建它需要切字素，所以组件里做 memo；每帧只跑后面那段廉价的时钟解析。
 */
...
export function SynchronizedTranslationText({
  ...
  return (
    <span className="karaoke-line karaoke-translation-line" aria-label={text}>
