...
/** 带上限的编辑距离：一旦超限立即返回，避免长歌词两两比较退化成 O(n²)。 */
...
/** 逐字轨与主歌词的精确对应：按去标点后的文本在归一化文本流里查找。 */
...
/** 精确匹配失败时的模糊匹配：限制编辑距离与时间偏差，取最优窗口。 */
...
/** 翻译 / 音译 / 读音轨：先按时间键精确对齐，剩余行再按时间就近认领。 */
